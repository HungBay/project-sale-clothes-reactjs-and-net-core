...
ListOrderCreate.propTypes = {};

function ListOrderCreate(props) {
  const { orders } = props;
  console.log(STATUS_ORDER);
  return (
    <div className="tab-pane fade" id="orderCreate">
      {orders
        ? orders
            .filter(orderDate => orderDate.statusOrder === STATUS_ORDER.create)
            .map((order, index) => (
...
export default ListOrderCreate;
